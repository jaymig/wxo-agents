...
- One comprehensive demonstration tool

---

### Part 2: Running the Complete Demonstration (3 minutes)

**Say**: "Let's run the complete PII redaction demonstration."
...
📋 STEP 1: Example PII Values to Write
------------------------------------------------------------
The following PII values will be written to context variables:
...
✍️  STEP 2: Writing to Context Variables
------------------------------------------------------------
Writing all PII values to their respective context variables...

✅ Successfully wrote 9 PII values to context variables

📖 STEP 3: Reading from Context Variables
------------------------------------------------------------
Reading back the values to confirm they were stored correctly:

[All 9 PII values displayed again]
...
**Explain**:
- "The agent called the `pii_redaction_demo` tool"
- "This single tool performs all three steps in one execution"
- "Step 1 shows what will be written, Step 2 writes to context, Step 3 verifies storage"
...
1. Run the PII redaction demonstration
2. Explain the 3-step process
3. Discuss redaction concept
4. Show one example (email or SSN)

### Technical Deep Dive (15 minutes)
1. Show agent YAML configuration
2. Explain context variable setup
3. Walk through the pii_redaction_demo tool code
