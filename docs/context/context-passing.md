# Getting Started with Context Variables

[Watsonx Orchestrate](https://developer.watson-orchestrate.ibm.com) (wxO) supports context variables.  Context variables are variables that can be set and passed from a web session to an agent and between agents.  Context variables will soon be available in Tools, Knowledge and Flows.
...
If you are ready to do that now, please proceed to [Configuring security and keys](./configuring-keys.md).
